...
"")
    ...
    def retranslateUi(self, opDesk):
        ...
        self.topBoxLocal.setItemText(1, _translate("opDesk", "U. G. Pessoas"))
        self.topBoxLocal.setItemText(2, _translate("opDesk", "U. A. Rural"))
        self.topBoxLocal.setItemText(3, _translate("opDesk", "U. Cadastro"))
        self.topBoxLocal.setItemText(4, _translate("opDesk", "U. Cobrança"))
        self.topBoxLocal.setItemText(5, _translate("opDesk", "Conselho ADM"))
        self.topBoxLocal.setItemText(6, _translate("opDesk", "U. Controladoria"))
        self.topBoxLocal.setItemText(7, _translate("opDesk", "U. Crédito"))
        self.topBoxLocal.setItemText(8, _translate("opDesk", "D. Operacional"))
        self.topBoxLocal.setItemText(9, _translate("opDesk", "U. Financeiro"))
        self.topBoxLocal.setItemText(10, _translate("opDesk", "U. G. Riscos"))
        self.topBoxLocal.setItemText(11, _translate("opDesk", "U. P. Serviços"))
        self.topBoxLocal.setItemText(12, _translate("opDesk", "U. Retaguarda"))
        self.topBoxLocal.setItemText(13, _translate("opDesk", "S. Executiva"))
        self.topBoxLocal.setItemText(14, _translate("opDesk", "U. Tecnologia"))
        self.topBoxLocal.setItemText(15, _translate("opDesk", "D. Administrativa"))
        self.topBoxLocal.setItemText(16, _translate("opDesk", "G. Operacional"))
        self.topBoxLocal.setItemText(17, _translate("opDesk", "G. Administrativa"))
        self.topBoxLocal.setItemText(18, _translate("opDesk", "G. Comercial"))
        self.topBoxLocal.setItemText(19, _translate("opDesk", "Recepção"))
        self.topBoxLocal.setItemText(20, _translate("opDesk", "PA - Planaltina"))
        self.topBoxLocal.setItemText(21, _translate("opDesk", "PA - São João"))
        self.topBoxLocal.setItemText(22, _translate("opDesk", "PA - SIA"))
        self.topBoxLocal.setItemText(23, _translate("opDesk", "PA - Águas Claras"))
        self.topBoxLocal.setItemText(24, _translate("opDesk", "PA -Pad/DF"))
        self.topBoxLocal.setItemText(25, _translate("opDesk", "PA - Vicente Pires"))
        self.topBoxLocal.setItemText(26, _translate("opDesk", "PA - Formosa"))
        self.topBoxLocal.setItemText(27, _translate("opDesk", "PA - São Sebastião"))
        self.topBoxLocal.setItemText(28, _translate("opDesk", "PA- Digital"))
